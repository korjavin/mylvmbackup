...
The I<purge> action can be used to remove older backups from the backup
directory, except for the a configurable number of most recent backups, defined
by the I<backupretention> option. The backup creation process is skipped in
this case.
...
I<tar>, I<rsync>, I<rsnap>, I<zbackup> and I<none>.
...
The default is I</usr/local/bin/zbackup>.
...
You may use I<--password-file /path/to/pass> for encrypted zbackup repos.

=item B<--zbackupdir=string>

Specifies the pathname of the directory where zbackup repos located.
You should init the repo  by I<zbackup init>  before use it.
