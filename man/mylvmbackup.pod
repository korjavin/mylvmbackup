...
partitions and the bindmounts before terminating. This option also
implies I<keep_snapshot=1>, as it would not be useful if the snapshot
is removed.
...
I<%Y> year (e.g. 2009),
I<%m> month (01..12),
I<%d> day of month (e.g. 01),
I<%h> month abbreviation, 
I<%H> hour, 24 hour clock, leading 0's)
I<%M> minute, leading 0's
I<%S> seconds, leading 0's
...
I<%M> minute, leading 0's
I<%S> seconds, leading 0's
Example: I<$backupdir=/path/to/%Y-%m-%d> will expand to I</path/to/2009-06-13>

Instead of a local directory, you can also provide a
