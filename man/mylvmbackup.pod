...
The I<purge> action can be used to remove all backups except for the a
configurable number of previous backups, defined by the I<backupretention>
...
or rsync URLs, the retention mode will not work.
