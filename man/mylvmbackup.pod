...
If this option is given, mylvmbackup will expect that the LVM volume is
...
Specifies how many previous backups to keep in the backup directory.
The default is I<0> (keep all backups).
