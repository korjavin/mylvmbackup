...
when running I<mylvmbackup> once per day). If you need to pass parameters
to the I<rsync> process used by I<rsnap>, just append them after a single
I<-->, e.g. I<rsnaparg=7 -- --exclude \*.o --bwlimit=8>.
